...
def classify_line_region_and_lane(frame):
    ...
    if lines is not None:
        ...
        left_lines, right_lines = divide_left_right(lines_reshaped)
...
def plot_lane_detection(frame, result, lpos, rpos, left_lines, right_lines, lidar_mask=None, show_center=True):
    """
    ...
    cv2.imshow("Lane + LiDAR Visualization", debug_img)
    cv2.waitKey(1)